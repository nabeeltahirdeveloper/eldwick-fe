...
export default function RecipeForm({ recipe, fetchData, setSelectedRecipe }) {
  ...
  const handleSubmit =async () => {
    ...
    if (recipe) {
      const res = await axios.post("/api/update-recipe", {...newRecipe, id: recipe._id});
      setSelectedRecipe()
    }
    else {
  ...
  return (
    <div className={`main-panel ${poppins.className}`}>
      <h1 className={poppins.className}>MAKE SHEET</h1>  {/* Optional: Add a title if you'd like */}
      ...
      <div className="form-container">
          ...
          <table border="1">
            ...
            <tr>
              ...
              <td><input type="text"
                ...
                onChange={(e) => setIngredientType({ ...ingredientType, starter: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientSupplier.starter}
                onChange={(e) => setIngredientSupplier({ ...ingredientSupplier, starter: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBatch.starter}
                onChange={(e) => setIngredientBatch({ ...ingredientBatch, starter: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBbe.starter}
                onChange={(e) => setIngredientBbe({ ...ingredientBbe, starter: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientQuantity.starter}
                onChange={(e) => setIngredientQuantity({ ...ingredientQuantity, starter: e.target.value })}
              /></td>
            </tr>
            <tr>
              <td>Cal. Chl.</td>
              <td><input type="text"
                ...
                onChange={(e) => setIngredientType({ ...ingredientType, calChl: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientSupplier.calChl}
                onChange={(e) => setIngredientSupplier({ ...ingredientSupplier, calChl: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBatch.calChl}
                onChange={(e) => setIngredientBatch({ ...ingredientBatch, calChl: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBbe.calChl}
                onChange={(e) => setIngredientBbe({ ...ingredientBbe, calChl: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientQuantity.calChl}
                onChange={(e) => setIngredientQuantity({ ...ingredientQuantity, calChl: e.target.value })}
              /></td>
            </tr>
            <tr>
              <td>Rennet</td>
              <td><input type="text"
                ...
                onChange={(e) => setIngredientType({ ...ingredientType, rennet: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientSupplier.rennet}
                onChange={(e) => setIngredientSupplier({ ...ingredientSupplier, rennet: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBatch.rennet}
                onChange={(e) => setIngredientBatch({ ...ingredientBatch, rennet: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBbe.rennet}
                onChange={(e) => setIngredientBbe({ ...ingredientBbe, rennet: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientQuantity.rennet}
                onChange={(e) => setIngredientQuantity({ ...ingredientQuantity, rennet: e.target.value })}
              /></td>
            </tr>
            <tr>
              <td>Geo</td>
              <td><input type="text"
                ...
                onChange={(e) => setIngredientType({ ...ingredientType, geo: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientSupplier.geo}
                onChange={(e) => setIngredientSupplier({ ...ingredientSupplier, geo: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBatch.geo}
                onChange={(e) => setIngredientBatch({ ...ingredientBatch, geo: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBbe.geo}
                onChange={(e) => setIngredientBbe({ ...ingredientBbe, geo: e.target.value })}
               /></td>
              <td><input type="text"
                value={ingredientQuantity.geo}
                onChange={(e) => setIngredientQuantity({ ...ingredientQuantity, geo: e.target.value })}
              /></td>
            </tr>
            <tr>
              <td>PC</td>
              <td><input type="text"
                ...
                onChange={(e) => setIngredientType({ ...ingredientType, pc: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientSupplier.pc}
                onChange={(e) => setIngredientSupplier({ ...ingredientSupplier, pc: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBatch.pc}
                onChange={(e) => setIngredientBatch({ ...ingredientBatch, pc: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBbe.pc}
                onChange={(e) => setIngredientBbe({ ...ingredientBbe, pc: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientQuantity.pc}
                onChange={(e) => setIngredientQuantity({ ...ingredientQuantity, pc: e.target.value })}
              /></td>
            </tr>
            <tr>
              <td>Salt</td>
              <td><input type="text"
                ...
                onChange={(e) => setIngredientType({ ...ingredientType, salt: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientSupplier.salt}
                onChange={(e) => setIngredientSupplier({ ...ingredientSupplier, salt: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBatch.salt}
                onChange={(e) => setIngredientBatch({ ...ingredientBatch, salt: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBbe.salt}
                onChange={(e) => setIngredientBbe({ ...ingredientBbe, salt: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientQuantity.salt}
                onChange={(e) => setIngredientQuantity({ ...ingredientQuantity, salt: e.target.value })}
              /></td>
            </tr>
            <tr>
              <td>Truffle (opt)</td>
              <td><input type="text"
                ...
                onChange={(e) => setIngredientType({ ...ingredientType, truffle: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientSupplier.truffle}
                onChange={(e) => setIngredientSupplier({ ...ingredientSupplier, truffle: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBatch.truffle}
                onChange={(e) => setIngredientBatch({ ...ingredientBatch, truffle: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientBbe.truffle}
                onChange={(e) => setIngredientBbe({ ...ingredientBbe, truffle: e.target.value })}
              /></td>
              <td><input type="text"
                value={ingredientQuantity.truffle}
                onChange={(e) => setIngredientQuantity({ ...ingredientQuantity, truffle: e.target.value })}
              /></td>
            </tr>
          </table>
        ...
        <div className='production-record'>
          <div className='production' style={{
            display: 'flex',
            ...
            <table border="1" style={{
              ...
              <tr>
                ...
                <td><input type="text" placeholder="Y/N"
                  value={cleanDown}
            ...
            <table border="1">
              ...
              <tr>
                ...
                <td><input type="text"
                  value={timeCulture}
                  onChange={(e) => setTimeCulture(e.target.value)}
                /></td>
              </tr>
              <tr>
                ...
                <td><input type="text"
                  value={timeRennet}
                  onChange={(e) => setTimeRennet(e.target.value)}
                /></td>
              </tr>
              <tr>
                ...
                <td><input type="text"
                  value={timeMould}
                  onChange={(e) => setTimeMould(e.target.value)}
                /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input type="text"
                  value={timeSalt}
                  onChange={(e) => setTimeSalt(e.target.value)}
                /></td>
              </tr>
              <tr>
                ...
                <td><input type="text"
                  value={timeSalt2}
                  onChange={(e) => setTimeSalt2(e.target.value)}
                /></td>
              </tr>
              <tr>
                ...
                dayData.map((day) => (
                  <tr>
                    ...
                    <td><input type="text"
                      ...
                      onChange={(e) => setTempRecords({ ...tempRecords, [day.key]: { ...tempRecords[day.key], am: e.target.value } })}
                    /></td>
                    <td><input type="text"
                      value={tempRecords[day.key].pm}
                      onChange={(e) => setTempRecords({ ...tempRecords, [day.key]: { ...tempRecords[day.key], pm: e.target.value } })}
                    /></td>
                  </tr>
                ))
        ...
        <div>
          <div>
                ...
                ['one', 'two', 'three', 'four', 'five', 'six'].map((num) => (
                  <tr>
                    <td><input type="text"
                      ...
                      onChange={(e) => setDisposal({ ...disposal, [num]: { ...disposal[num], name: e.target.value } })}
                    /></td>
                    <td><input type="text"
                      value={disposal[num].amount}
                      onChange={(e) => setDisposal({ ...disposal, [num]: { ...disposal[num], amount: e.target.value } })}
                    /></td>
                  </tr>
                ))
              }
            ...
            <textarea name="" placeholder='Observations' id="" cols="30" rows="10"
              value={observations}
      ...
      <div style={{
        ...
        {recipe && <button className="button-red" style={{
          backgroundColor: 'red',
